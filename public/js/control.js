...
function checkTakePass(){
	if(document.ftpass.email2.value==''){
...
function checksignin(){
	...
	if(document.fsignin.ho.value==''){
		document.getElementById('error-ho').style.display = "block";
		document.getElementById('ho').style.borderColor ="red";
	    return false;
	}
	if(document.fsignin.email.value==''){
		document.getElementById('error-email').style.display = "block";
		document.getElementById('email').style.borderColor ="red";
	    return false;
	}
	if(document.fsignin.pass.value==''){
		document.getElementById('error-pass').style.display = "block";
		document.getElementById('pass').style.borderColor ="red";
	    return false;
	}
