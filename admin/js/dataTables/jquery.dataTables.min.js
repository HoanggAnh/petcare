...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu tiên",sLast:"Cuối cùng",sNext:"Kế tiếp",sPrevious:"Trước"},sEmptyTable:"Dữ liệu không sẵn có trong bảng",sInfo:"Hiển thị _START_ đến _END_ of _TOTAL_ mục",sInfoEmpty:"Hiển thị 0 đến 0 of 0 mục",sInfoFiltered:"(được lọc từ _MAX_ thú nuôi)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục",sLoadingRecords:"Đang tải...",sProcessing:"Đang xử lý...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
