<div class="container-fluid">
	<div class="row">
	<div class="card-header text-center" style="background-color: #323741;font-size: 17px; color: 
#fcc39b; border-radius: 30px; margin-top: 80px; margin-bottom:20px"><i class="fas fa-paw"></i> LATEST PRODUCT <i class="fas fa-paw"></i></div>
		<div class="col-lg-12">
			<div class="products">
				<?php
